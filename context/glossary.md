...
> **2026-06-26 제약 이관(OI-10)**: **QA-06 Security/Safety → 제약 `C-03`으로 이관**(헤드라인 0건 절대형 = pass/fail 게이트라 QA 부적합). QA-07~13은 현 번호 유지(QA-06은 공석), 짝 QAS-06 제거. ASR = QA-01~05, QA-07로 축소.
