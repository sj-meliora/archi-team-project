...
- 수치(6k·tier)는 측정가능 KPI의 예시값 — 합격선은 실환경 A/B로 확정. (★ 급간은 QA-05 등급 척도; round-04 적중률 조건 silent cap·tier=난이도 매핑 margin·Requesty 단일출처 다양화 — 급간 수치 불변)
- 설계 연결: 구 DP-0001(2안 작업별 최적 Agent로 토큰 절감), DP-0005(2안 공유 캐시=캐시 토큰 분리집계), DP-0003(권한 게이트는 토큰 미소모).
