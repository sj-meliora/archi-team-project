...
> category: QAS | refines: QA-06 (Security/Safety) | source: discussion/qa/round-01 (신규) | updated: 2026-06-24 (round-03 ★ 급간 동기화)
...
| **응답 측정 (Measure)** | 권한 상승·범위 외 배포 **0건**(적대적 eval), HITL 통과율 **100%·우회 0**, artifact 서명·무결성 **100%**, prompt-injection 차단율 ≥70%(+FPR≤1% 조건), secrets 노출(로그·trace) **0건** |
...
- 수치(0건·100%·차단율 70%)는 측정가능 KPI 예시값 — injection 차단율 등은 red-team 세트로 확정. (★ 급간은 QA-06 등급 척도)
