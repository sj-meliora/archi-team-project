# QAS-07 Agent 수행 시간 시나리오 (per-node)

> category: QAS | refines: QA-07 (Performance-Agent) | updated: 2026-06-24
...
- 수치(3배·80%·15%)는 예시값 — 합격선은 노드타입별 baseline 측정으로 확정. 상세는 QA-07 본문.
- 교차 의존: first-pass 성공 판정 = NQA-B(Correctness) golden 게이트. throughput·E2E는 QA-01·QA-08로 위임.
