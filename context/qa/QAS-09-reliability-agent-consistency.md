...
> category: QAS | refines: QA-09 (Reliability-Agent) | updated: 2026-06-24 (round-01 contention 반영)
...
| **응답 측정 (Measure)** | **(주) 캐시 On/Off 일관성 갭 Δ** 대조 시연(명제 "캐시는 일관성 입증 아님); (보조) 순수 추론 pass^k(k=5, 예시 ≥70%); ②-1 대리 유효-결정률 **≥95%**(룰 게이트); ②-2 정밀 유효-결정률(NQA-B 의존, open-issue); 재실행 분산 **H_norm ≤0.2** |
