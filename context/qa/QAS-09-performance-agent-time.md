...
> category: QAS | refines: QA-09 (Performance-Agent) | updated: 2026-06-24 (round-03 ★ 급간 동기화)
...
- 수치(1~3배·80%·15%)는 예시값 — 합격선은 노드타입별 baseline 측정으로 확정. 상세는 QA-09 본문. (★ 급간은 QA-09 등급 척도)
