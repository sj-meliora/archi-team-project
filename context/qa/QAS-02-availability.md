...
> category: QAS | refines: QA-02 (Availability) | updated: 2026-06-24
...
| **응답 측정 (Measure)** | 재기동 ≤1분 AND in-flight 손실=0, 워크플로우 성공률 ≥99.5%, 외부 LLM 장애 자동 재개율 ≥95%, side-effect 멱등성=100% |

## 비고
- 설계 연결: DP-0002(3안 H+Standby — control-plane HA), DP-0003(2안 격리·3안 모니터링 — 외부 장애 흡수).
- 경계: QA-02 = 장애 단위의 **복구**, QA-06 = 타 단위로의 **격리**(blast-radius 차단).
