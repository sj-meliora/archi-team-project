...
| F-04 | **CRITICAL** | claim-check가 곧 QA-10의 '전달 오버헤드'인데 모든 안이 **순이익으로 오인** — 2안의 핵심 강점을 버리는 비용 미정량 |
| F-05 | **CRITICAL** | 멱등 가정이 A3/A4/A5/A6의 load-bearing인데 시스템 자체 **QA-11 재현율≥80%(비결정성)와 모순** |
