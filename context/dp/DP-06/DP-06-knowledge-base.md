...
> category: DP | status: 초안 v4.1 (2026-08-13 전 QA 스크리닝 보강 — 팀 검토 대기) | source: 신규 발굴 (자율 이슈처리 서사의 지식 공급 공백) + 필드 레퍼런스(Cerebras Knowledge·Wikipedia 문서 보호 정책·Blackboard 패턴) | updated: 2026-08-13
...
| **QA-05 Efficiency** (5) | 변별 (기존 v4) | **★★★** | ★★☆ | 1안 단일 위키·안정 문서 = prompt cache 친화. 2안 정본+런타임 이중 조회, 런타임은 갱신이 잦아 캐시 비친화 (A3 표와 동일) |
